...
public class ViewBookedHotel extends JFrame implements ActionListener{
	...
	ViewBookedHotel(String username){
		...
		labelpackage.setForeground(Color.BLUE);
		add(labelpackage);
		...
		labelpersons.setForeground(Color.BLUE);
		add(labelpersons);
		...
		labeldays.setForeground(Color.BLUE);
		add(labeldays);
		...
		labelac.setForeground(Color.BLUE);
		add(labelac);
		...
		labelfood.setForeground(Color.BLUE);
		add(labelfood);
		...
		labelprice.setForeground(Color.BLUE);
		add(labelprice);
