...
public class CheckHotels extends JFrame implements Runnable {
	...
	JLabel caption;
	public void run() {
		String[] text = new String[] {"Marriot Hotel","Taj Hotel","Four Seasons Hotel","Rassison Blue Hotel","Classino Hotel","Marine Hotel","Dolphin Hotel","The Bay Club Hotel","Brezee Hotel","River View Hotel"};
		try {
			for(int i=0;i<=9;i++) {
	...
	CheckHotels(){
		...
		caption.setFont(new Font("Tahome",Font.PLAIN,40));
